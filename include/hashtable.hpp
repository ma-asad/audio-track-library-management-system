...
private:
     ...
     *
     * This function takes a key as input and generates a hash value using a hashing algorithm.
...
public:
    ...
    */
     ...
     *
     * This destructor is responsible for cleaning up any dynamically allocated memory
     * and performing any necessary cleanup operations when an instance of the HashTable class
     * is destroyed.
    */
    ~HashTable();
    ...
    */
     ...
     *
     * @param items A pointer to an array of std::pair<Key, Value> objects to store the retrieved items.
     * @param counter A reference to a size_t variable to store the number of retrieved items.
    */
