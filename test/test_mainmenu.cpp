...
TEST_CASE("Main Menu Selection") {
  ...
  SECTION("Selecting invalid option") {
    ...
    REQUIRE(output.find("Invalid choice. Press 'Enter' to try again.") !=
            std::string::npos);
  }
  ...
  SECTION("Checking if menu is correctly displayed") {
    ...
    REQUIRE(output.find("| 1. Add Audio File                           |") !=
            std::string::npos);
    REQUIRE(output.find("| 2. List Audio                               |") !=
            std::string::npos);
    REQUIRE(output.find("| 3. Search                                   |") !=
            std::string::npos);
    REQUIRE(output.find("| 4. Create Playlist                          |") !=
            std::string::npos);
    REQUIRE(output.find("| 5. Delete                                   |") !=
            std::string::npos);
    REQUIRE(output.find("| 6. Exit                                     |") !=
            std::string::npos);
  }
}